          ...
          containerOverrides:[
            {
              ...
              environment:[
                {
                  name:'MY_ACCESS_KEY_ID',value:process.env.ACCESS_KEY_ID!
                },
                {
                    name:'MY_SECRET_ACCESS_KEY',value:process.env.SECRET_ACCESS_KEY!
                },
                {
                    name:'MY_BUCKET_NAME',value:myBucketName
                },
                {
                    name:'USER_ACCESS_KEY_ID',value:runObj.userAccessKey
                },
                {
                    name:'USER_SECRET_ACCESS_KEY',value:runObj.userSecretAccessKey
                },
                {
                    name:'USER_BUCKET_NAME',value:runObj.userBucketName
                },
                {
                    name:'VIDEO_KEY',value:runObj.videoKey
                },
                {
                    name:'BUCKET_PATH',value:runObj.bucketPath
                },
                {
                    name:'QUEUE_HOST',value:queueHost
                },
                {
                    name:'QUEUE_USER',value:queueUser
                },
                {
                    name:'QUEUE_PASSWORD',value:queuePassword
                },
                {
                    name:'USER_EMAIL',value:runObj.email
                }
              ]
            }
          ]
          ...
          containerOverrides:[
            {
              ...
              environment:[
                ...
                {
                  name:'GIT_URL',value:runObj.gitUrl
                },{
                  name:'WEB_URL',value:runObj.webUrl
                }
              ]
            }
          ]
